    ...
    <div v-if="showFlag">
      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-form-item label="企业编号">
          <el-input v-model="searchForm.companynumber"
      ...
      <div class="table-content">
        <el-table
          ...
          <el-table-column
              ...
              label="操作">
            <template slot-scope="scope">
              <el-button v-if="isAuth('companyinfo','查看')" type="text" icon="el-icon-edit" size="small"
                         @click="addOrUpdateHandler(scope.row.id,'info')">详情
              </el-button>
              <el-button v-if="isAuth('companyinfo','修改')" type="text" icon="el-icon-edit" size="small"
                         @click="addOrUpdateHandler(scope.row.id)">修改
              </el-button>
              <el-button v-if="isAuth('companyinfo','删除')" type="text" icon="el-icon-delete" size="small"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (this.searchForm.companynumber != '' && this.searchForm.companynumber != undefined) {
        params['companynumber'] = '%' + this.searchForm.companynumber + '%'
      }
...
.main-content {
  background-image: url('../../../assets/img/backgroungimg (2).png'); /* 确保路径正确 */
