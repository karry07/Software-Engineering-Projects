            ...
            <div class="table-content">
                <el-table
                    ...
                    <el-table-column
                            ...
                            label="操作">
                        <template slot-scope="scope">
                            <el-button v-if="isAuth('generaluser','查看')" type="text" icon="el-icon-edit" size="small"
                                       @click="addOrUpdateHandler(scope.row.id,'info')">详情
                            </el-button>
                            <el-button v-if="isAuth('generaluser','修改')" type="text" icon="el-icon-edit" size="small"
                                       @click="addOrUpdateHandler(scope.row.id)">修改
                            </el-button>
                            <el-button v-if="isAuth('generaluser','删除')" type="text" icon="el-icon-delete" size="small"
...
.main-content {
  background-image: url('../../../assets/img/backgroungimg (1).png'); /* 确保路径正确 */
