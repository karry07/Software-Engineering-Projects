  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-form-item label="查询学历">
          <el-input v-model="searchForm.education"
                    placeholder="请输入查询的学历信息" clearable></el-input>
        </el-form-item>
        <el-form-item>
          <el-button round @click="search()">查询</el-button>
          <el-button
              v-if="isAuth('educationinfo','新增')"
              type="primary"
      ...
      <div class="table-content">
        <el-table
          ...
          <el-table-column
              ...
              label="操作">
            <template slot-scope="scope">
              <el-button  v-if="isAuth('educationinfo','查看')" type="text" icon="el-icon-view" size="small"
                         @click="addOrUpdateHandler(scope.row.id,'info')">详情
              </el-button>
              <el-button v-if="isAuth('educationinfo','修改')" type="text" icon="el-icon-edit" size="small"
                         @click="addOrUpdateHandler(scope.row.id)">修改
              </el-button>
              <el-button v-if="isAuth('educationinfo','删除')" type="text" icon="el-icon-delete" size="small"
...
.main-content {
  background-image: url('../../../assets/img/educationinfobackground.png'); /* 确保路径正确 */
